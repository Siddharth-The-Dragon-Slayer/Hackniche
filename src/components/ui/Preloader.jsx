...
export default function Preloader() {
  ...
  const shouldSkipPreloader =
    pathname?.includes("/events/") || pathname?.includes("/billing/");
      ...
      <div className={`pre-overlay${phase === "exit" ? " exit" : ""}`}>
        ...
        <div className="pre-stage">
          ...
          <div className="pre-center-container">
            ...
            <div
              className={`pre-logo-wrap${phase === "logo" || phase === "text" || phase === "tagline" || phase === "exit" ? " visible" : ""}`}
            >
              <Image
                src="/BanquetEase.png"
                alt="BanquetEase"
          ...
          <div className={`pre-text-wrap${phase === "text" ? " visible" : ""}`}>
            <div
              className={`pre-typewriter${textState === fullText ? " done" : ""}`}
            >
              {textState}
            </div>
          </div>
          ...
          {/* Tagline */}
          <span
            className={`pre-tagline${phase === "tagline" ? " visible" : ""}`}
            aria-hidden="true"
          >
            Banquet Management
          </span>
