...
export async function PATCH(request, { params }) {
  ...
  const update = {
    ...
    ...(body.google_rating != null && {
      google_rating: Number(body.google_rating),
    }),
    ...(body.review_count != null && {
      review_count: Number(body.review_count),
    }),
    ...(body.cost_for_two != null && {
      cost_for_two: Number(body.cost_for_two),
    }),
