...
export const offersData = [
  {
    ...
    description: 'Book 120+ days in advance and save 10% on your base hall rent. Perfect for couples planning ahead!',
    type: 'percentage',
    discountValue: 10,
    ...
    terms: 'Valid only for bookings made 120+ days before the event date. Cannot be combined with other offers.',
  },
  {
    id: 'OFF002',
    title: 'Monsoon Magic Deal',
    description: 'Enjoy special discounted pricing for July–August events. Beat the crowd with off-season charm!',
    type: 'percentage',
    discountValue: 15,
    ...
    active: true,
    consumerVisible: true,
    terms: 'Valid for events held between July 1 and August 31, 2026. Applicable on hall rent only.',
  },
  {
    id: 'OFF003',
    title: 'Corporate Midweek Package',
    description: 'Book Mon–Thu for corporate events and get a flat ₹20,000 off + complimentary AV setup.',
    type: 'flat',
    discountValue: 20000,
    validFrom: '2026-03-01',
    validTo: '2026-12-31',
    ...
    active: true,
    consumerVisible: true,
    terms: 'Valid for Monday–Thursday bookings only. Free AV setup includes projector, screen, and microphones.',
  },
  {
    id: 'OFF004',
    title: 'Grand Wedding Bundle',
    description: 'Book Grand Ballroom for 450+ guests and get free décor package worth ₹50,000 included!',
    type: 'addon',
    discountValue: 50000,
    validFrom: '2026-03-01',
    validTo: '2027-02-28',
    ...
    active: true,
    consumerVisible: true,
    terms: 'Minimum 450 guests required. Free décor package includes floral arrangements, stage setup, and lighting.',
  },
  {
    id: 'OFF005',
    title: 'Loyalty Repeat Booking',
    description: 'Returning customers get 8% off their next event booking as a thank-you from our team.',
    type: 'percentage',
    discountValue: 8,
    ...
    terms: 'Applicable to customers with at least one prior confirmed event at any branch.',
  },
];
...
export const sidebarMenus = {
  ...
  franchise_admin: [
    ...
    { icon: '🤝', label: 'Vendors', href: '/vendors' },    { icon: '🎁', label: 'Offers & Coupons', href: '/offers' },    { icon: '📊', label: 'Analytics', href: '/analytics' },
