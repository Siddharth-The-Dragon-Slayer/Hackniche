...
function WeddingPoster({ f }) {
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', { style: { position: 'absolute', top: 18, left: 18, right: 18, bottom: 18, border: `2.5px solid ${gold}`, borderRadius: 4 } }),
    React.createElement('div', { style: { position: 'absolute', top: 26, left: 26, right: 26, bottom: 26, border: `1px solid rgba(201,168,76,0.45)`, borderRadius: 2 } }),
    ...
    ...['top:12;left:12', 'top:12;right:12', 'bottom:12;left:12', 'bottom:12;right:12'].map((pos, i) => {
      ...
      return React.createElement('div', {
        key: i,
        style: {
          position: 'absolute', ...Object.fromEntries(Object.entries(p).map(([k, v]) => [k, parseInt(v)])),
          width: 28, height: 28,
    ...
    React.createElement('div', {
      style: { display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', paddingTop: 72, paddingBottom: 60, paddingLeft: 60, paddingRight: 60, boxSizing: 'border-box' }
    },
      /* "With Great Joy" */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 14, fontWeight: 400, letterSpacing: 4, textTransform: 'uppercase', color: darkGold, marginBottom: 10, marginTop: 0 } }, 'WITH GREAT JOY'),

      /* Thin divider */
      React.createElement('div', { style: { width: 120, height: 1.5, background: `linear-gradient(90deg, transparent,${gold},transparent)`, marginBottom: 18 } }),

      /* You Are Invited */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 46, fontWeight: 700, color: '#3A2A0A', textAlign: 'center', marginBottom: 6, marginTop: 0, letterSpacing: 1 } }, 'You Are Invited'),

      /* to the wedding of */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 14, fontWeight: 400, letterSpacing: 3, textTransform: 'uppercase', color: darkGold, marginBottom: 26, marginTop: 0 } }, 'TO THE WEDDING OF'),

      /* Divider with diamond */
      React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 12, marginBottom: 26, width: '100%', justifyContent: 'center' } },
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, transparent, ${gold})` } }),
        React.createElement('div', { style: { width: 10, height: 10, background: gold, transform: 'rotate(45deg)' } }),
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, ${gold}, transparent)` } }),
      ),

      /* Bride Name */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 52, fontWeight: 700, color: darkGold, textAlign: 'center', marginBottom: 4, marginTop: 0, letterSpacing: 1 } }, bride),

      /* & symbol */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 38, fontWeight: 400, color: gold, textAlign: 'center', marginBottom: 4, marginTop: 0 } }, '&'),

      /* Groom Name */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 52, fontWeight: 700, color: darkGold, textAlign: 'center', marginBottom: 30, marginTop: 0, letterSpacing: 1 } }, groom),

      /* Divider with diamond */
      React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 12, marginBottom: 36, width: '100%', justifyContent: 'center' } },
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, transparent, ${gold})` } }),
        React.createElement('div', { style: { width: 10, height: 10, background: gold, transform: 'rotate(45deg)' } }),
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, ${gold}, transparent)` } }),
      ),
      ...
      /* RSVP */
      rsvp && React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 16, marginBottom: 16 } },
        React.createElement('div', { style: { width: 40, height: 1, background: gold } }),
        React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 13, fontWeight: 700, color: darkGold, textAlign: 'center', marginBottom: 0, marginTop: 0, letterSpacing: 1 } },
      ...
      /* Bottom ornament */
      React.createElement('div', { style: { marginTop: 'auto', paddingTop: 20, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 } },
        React.createElement('div', { style: { display: 'flex', gap: 8, alignItems: 'center' } },
          React.createElement('div', { style: { width: 6, height: 6, borderRadius: '50%', background: gold } }),
          React.createElement('div', { style: { width: 10, height: 10, background: gold, transform: 'rotate(45deg)' } }),
          React.createElement('div', { style: { width: 6, height: 6, borderRadius: '50%', background: gold } }),
        ),
      ),
...
function BirthdayPoster({ f }) {
  ...
  return React.createElement('div', {
    style: {
      ...
      display: 'flex', flexDirection: 'column', alignItems: 'center',
      fontFamily: '"Raleway", sans-serif', position: 'relative',
    }
  },
    /* Gold top accent bar */
    React.createElement('div', { style: { width: '100%', height: 6, background: `linear-gradient(90deg, ${purple}, ${gold}, ${purple})` } }),
    /* Gold bottom accent bar */
    React.createElement('div', { style: { position: 'absolute', bottom: 0, left: 0, right: 0, height: 6, background: `linear-gradient(90deg, ${purple}, ${gold}, ${purple})` } }),

    /* Side border */
    React.createElement('div', { style: { position: 'absolute', top: 30, left: 22, bottom: 30, width: 2, background: `linear-gradient(180deg, transparent, ${gold}, transparent)` } }),
    React.createElement('div', { style: { position: 'absolute', top: 30, right: 22, bottom: 30, width: 2, background: `linear-gradient(180deg, transparent, ${gold}, transparent)` } }),
    ...
    ...Array.from({ length: 8 }).map((_, i) =>
      React.createElement('div', {
        ...
        style: {
          position: 'absolute',
          width: [6,4,5,3,7,4,5,6][i], height: [6,4,5,3,7,4,5,6][i],
    ...
    /* Content */
    React.createElement('div', {
      style: { display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 70, paddingBottom: 60, paddingLeft: 70, paddingRight: 70, boxSizing: 'border-box', width: '100%' }
    },
      /* "You're Invited To" */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 13, fontWeight: 700, letterSpacing: 4, textTransform: 'uppercase', color: gold, marginBottom: 8, marginTop: 0 } }, "YOU'RE INVITED TO CELEBRATE"),

      /* Gold divider */
      React.createElement('div', { style: { width: 100, height: 2, background: gold, marginBottom: 24 } }),

      /* 🎂 emoji area */
      React.createElement('div', { style: { fontSize: 72, marginBottom: 20 } }, '🎂'),

      /* Heading */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 38, fontWeight: 700, color: '#FFFFFF', textAlign: 'center', marginBottom: 8, marginTop: 0, letterSpacing: 1 } }, age ? `A ${age}th Birthday` : 'A Birthday Celebration'),

      /* Name */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 58, fontWeight: 700, color: gold, textAlign: 'center', marginBottom: 6, marginTop: 0, letterSpacing: 1 } }, name),

      /* Gold strip line */
      React.createElement('div', { style: { width: 200, height: 3, background: `linear-gradient(90deg, transparent, ${gold}, transparent)`, marginBottom: 8 } }),
      ...
      rsvp && React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 13, fontWeight: 600, color: lightGold, textAlign: 'center', marginBottom: 0, marginTop: 0 } },
        `RSVP${rsvpBy ? ` by ${rsvpBy}` : ''}: ${rsvp}`
      ),

      React.createElement('div', { style: { marginTop: 'auto', paddingTop: 24, display: 'flex', gap: 10, alignItems: 'center' } },
        React.createElement('div', { style: { width: 6, height: 6, background: gold, transform: 'rotate(45deg)' } }),
        React.createElement('div', { style: { width: 60, height: 1, background: gold } }),
...
function AnniversaryPoster({ f }) {
  ...
  return React.createElement('div', {
    ...
    /* Outer border */
    React.createElement('div', { style: { position: 'absolute', top: 18, left: 18, right: 18, bottom: 18, border: `2.5px solid ${bronze}`, borderRadius: 4 } }),
    React.createElement('div', { style: { position: 'absolute', top: 28, left: 28, right: 28, bottom: 28, border: `1px solid rgba(184,115,51,0.3)`, borderRadius: 2 } }),

    /* Amber top accent */
    React.createElement('div', { style: { position: 'absolute', top: 18, left: 18, right: 18, height: 6, background: `linear-gradient(90deg, transparent, ${amber}, transparent)` } }),
    React.createElement('div', { style: { position: 'absolute', bottom: 18, left: 18, right: 18, height: 6, background: `linear-gradient(90deg, transparent, ${amber}, transparent)` } }),

    /* Content */
    React.createElement('div', {
      style: { display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 68, paddingBottom: 60, paddingLeft: 60, paddingRight: 60, boxSizing: 'border-box', width: '100%' }
    },
      /* Big milestone circle */
      React.createElement('div', { style: { width: 130, height: 130, borderRadius: '50%', background: 'transparent', border: `3px solid ${bronze}`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginBottom: 24 } },
        React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 48, fontWeight: 700, color: bronze, marginBottom: 0, marginTop: 0, lineHeight: 1 } }, years),
        React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 10, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', color: amber, marginBottom: 0, marginTop: 2 } }, 'YEARS'),
      ),

      /* Label */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 13, fontWeight: 700, letterSpacing: 4, textTransform: 'uppercase', color: bronze, marginBottom: 6, marginTop: 0 } }, label || 'ANNIVERSARY CELEBRATION'),

      /* Divider */
      React.createElement('div', { style: { width: 120, height: 1.5, background: `linear-gradient(90deg, transparent, ${amber}, transparent)`, marginBottom: 24 } }),

      /* Celebrating */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 14, fontWeight: 400, letterSpacing: 3, textTransform: 'uppercase', color: '#8B6030', marginBottom: 16, marginTop: 0 } }, 'CELEBRATING'),

      /* Couple Name */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 50, fontWeight: 700, color: darkBrown, textAlign: 'center', marginBottom: 10, marginTop: 0, letterSpacing: 1 } }, couple),

      /* Gold diamond row */
      React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 } },
        React.createElement('div', { style: { width: 60, height: 1, background: `linear-gradient(90deg, transparent, ${bronze})` } }),
        React.createElement('div', { style: { fontSize: 22 } }, '🌹'),
        React.createElement('div', { style: { width: 60, height: 1, background: `linear-gradient(90deg, ${bronze}, transparent)` } }),
      ),

      /* "Together for X years" */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 16, fontWeight: 400, color: '#7A5A30', textAlign: 'center', marginBottom: 28, marginTop: 6 } }, `A journey of ${years} beautiful years together`),

      /* Hosted by */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 14, fontWeight: 400, color: '#8B6030', textAlign: 'center', marginBottom: 28, marginTop: 0 } }, `Hosted by ${hostedBy}`),
      ...
      rsvp && React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 13, fontWeight: 600, color: bronze, textAlign: 'center', marginBottom: 0, marginTop: 0 } },
        `RSVP${rsvpBy ? ` by ${rsvpBy}` : ''}: ${rsvp}`
      ),

      React.createElement('div', { style: { marginTop: 'auto', paddingTop: 20, display: 'flex', gap: 8, alignItems: 'center' } },
        React.createElement('div', { style: { width: 6, height: 6, borderRadius: '50%', background: amber } }),
        React.createElement('div', { style: { width: 6, height: 6, background: amber, transform: 'rotate(45deg)' } }),
        React.createElement('div', { style: { width: 6, height: 6, borderRadius: '50%', background: amber } }),
      ),
    )
  );
...
function CorporatePoster({ f }) {
  ...
  return React.createElement('div', {
    ...
    /* Top accent bar */
    React.createElement('div', { style: { width: '100%', height: 5, background: `linear-gradient(90deg, ${blue}, ${lightBlue}, ${blue})` } }),

    /* Left vertical accent */
    React.createElement('div', { style: { position: 'absolute', top: 60, left: 44, bottom: 60, width: 3, background: `linear-gradient(180deg, transparent, ${blue}, transparent)` } }),
    ...
    /* Content */
    React.createElement('div', {
      style: { display: 'flex', flexDirection: 'column', paddingTop: 60, paddingBottom: 60, paddingLeft: 80, paddingRight: 60, boxSizing: 'border-box', width: '100%', height: '100%' }
    },
      /* Company name */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 13, fontWeight: 700, letterSpacing: 4, textTransform: 'uppercase', color: lightBlue, marginBottom: 10, marginTop: 0 } }, company),

      /* Thin divider line */
      React.createElement('div', { style: { width: 60, height: 2.5, background: blue, marginBottom: 28 } }),

      /* invites you to */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 14, fontWeight: 400, color: silver, marginBottom: 16, marginTop: 0 } }, 'CORDIALLY INVITES YOU TO'),

      /* Event Title */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 46, fontWeight: 700, color: '#FFFFFF', marginBottom: 16, marginTop: 0, lineHeight: 1.2, maxWidth: 580 } }, title),

      /* Theme/Tagline */
      theme && React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 12, marginBottom: 40 } },
        React.createElement('div', { style: { width: 3, height: 28, background: blue, borderRadius: 2, flexShrink: 0 } }),
        React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 16, fontWeight: 400, color: lightBlue, marginBottom: 0, marginTop: 0, fontStyle: 'italic' } }, `"${theme}"`),
      ),
      ...
      React.createElement('div', { style: { marginTop: 'auto', display: 'flex', alignItems: 'center', gap: 12 } },
        React.createElement('div', { style: { width: 30, height: 1, background: blue } }),
        React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 11, fontWeight: 700, letterSpacing: 3, textTransform: 'uppercase', color: silver, marginBottom: 0, marginTop: 0 } }, 'LOOKING FORWARD TO SEEING YOU'),
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, ${blue}, transparent)` } }),
      ),
    )
  );
}
...
function EngagementPoster({ f }) {
  ...
  return React.createElement('div', {
    ...
    /* Outer frame */
    React.createElement('div', { style: { position: 'absolute', top: 18, left: 18, right: 18, bottom: 18, border: `2px solid ${rose}`, borderRadius: 4 } }),
    React.createElement('div', { style: { position: 'absolute', top: 26, left: 26, right: 26, bottom: 26, border: `1px solid rgba(232,99,122,0.25)`, borderRadius: 2 } }),

    /* Top accent */
    React.createElement('div', { style: { position: 'absolute', top: 18, left: 18, right: 18, height: 5, background: `linear-gradient(90deg, transparent, ${rose}, transparent)` } }),
    React.createElement('div', { style: { position: 'absolute', bottom: 18, left: 18, right: 18, height: 5, background: `linear-gradient(90deg, transparent, ${rose}, transparent)` } }),

    /* Floating circles (decorative petals) */
    ...[[680, 60, 40], [720, 90, 30], [50, 70, 35], [80, 110, 25], [660, 980, 40], [700, 1010, 28], [40, 960, 36], [70, 1000, 22]].map(([x, y, s], i) =>
      React.createElement('div', {
        key: `petal${i}`,
        style: { position: 'absolute', left: x, top: y, width: s, height: s, borderRadius: '50%', background: rose, opacity: 0.07 }
      })
    ),

    /* Content */
    React.createElement('div', {
      style: { display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 72, paddingBottom: 60, paddingLeft: 60, paddingRight: 60, boxSizing: 'border-box', width: '100%' }
    },
      /* Diamond icon */
      React.createElement('div', { style: { fontSize: 56, marginBottom: 14 } }, '💍'),

      /* They're engaged */
      React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 13, fontWeight: 700, letterSpacing: 4, textTransform: 'uppercase', color: rose, marginBottom: 8, marginTop: 0 } }, "THEY'RE GETTING ENGAGED"),

      /* Divider */
      React.createElement('div', { style: { width: 100, height: 1.5, background: `linear-gradient(90deg, transparent, ${rose}, transparent)`, marginBottom: 28 } }),

      /* Partner 1 */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 54, fontWeight: 700, color: pinkDeep, textAlign: 'center', marginBottom: 6, marginTop: 0, letterSpacing: 1 } }, p1),

      /* & */
      React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 14, marginBottom: 6, width: '80%' } },
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, transparent, ${rose})` } }),
        React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 34, fontWeight: 400, color: rose, marginBottom: 0, marginTop: 0 } }, '&'),
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, ${rose}, transparent)` } }),
      ),

      /* Partner 2 */
      React.createElement('p', { style: { fontFamily: '"Playfair Display"', fontSize: 54, fontWeight: 700, color: pinkDeep, textAlign: 'center', marginBottom: 10, marginTop: 0, letterSpacing: 1 } }, p2),

      /* Host families */
      (hf1 || hf2) && React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 14, fontWeight: 400, color: '#A06070', textAlign: 'center', marginBottom: 30, marginTop: 10 } },
        [hf1, hf2].filter(Boolean).join('  ·  ')
      ),

      /* Rose divider */
      React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 10, marginBottom: 30, width: '70%' } },
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, transparent, ${champagne})` } }),
        React.createElement('div', { style: { fontSize: 18 } }, '🌸'),
        React.createElement('div', { style: { flex: 1, height: 1, background: `linear-gradient(90deg, ${champagne}, transparent)` } }),
      ),
      ...
      rsvp && React.createElement('p', { style: { fontFamily: '"Raleway"', fontSize: 13, fontWeight: 600, color: rose, textAlign: 'center', marginBottom: 0, marginTop: 0 } },
        `RSVP${rsvpBy ? ` by ${rsvpBy}` : ''}: ${rsvp}`
      ),

      React.createElement('div', { style: { marginTop: 'auto', paddingTop: 20, display: 'flex', gap: 8, alignItems: 'center' } },
        React.createElement('div', { style: { width: 5, height: 5, borderRadius: '50%', background: rose } }),
        React.createElement('div', { style: { width: 8, height: 8, background: rose, transform: 'rotate(45deg)' } }),
        React.createElement('div', { style: { width: 5, height: 5, borderRadius: '50%', background: rose } }),
      ),
    )
  );
