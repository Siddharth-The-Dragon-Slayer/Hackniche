              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  <div className="kpi-card">
                    ...
                    <div className="kpi-value">{bookingData.length}</div>
                  </div>
                  <div className="kpi-card">
                    ...
                    <div className="kpi-value">
                      ₹
                      {(
                        bookingData.reduce((s, b) => s + b.total, 0) / 100000
                      ).toFixed(1)}
                      L
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="kpi-card">
                  ...
                  <div className="kpi-value">
                    ₹
                    {(
                      paymentData.reduce((s, p) => s + p.amount, 0) / 100000
                    ).toFixed(1)}
                    L
                  </div>
                </div>
                <div className="kpi-card">
                  ...
                  <div className="kpi-value">{paymentData.length}</div>
                </div>
                <div className="kpi-card">
                  ...
                  <div className="kpi-value">
                    ₹
                    {(
                      paymentData.reduce((s, p) => s + p.amount, 0) /
                      paymentData.length /
                      1000
                    ).toFixed(0)}
                    K
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="kpi-card">
                  ...
                  <div className="kpi-value">{eventData.length}</div>
                </div>
                <div className="kpi-card">
                  <div className="kpi-label">Upcoming</div>
                  <div className="kpi-value">
                    {eventData.filter((e) => e.status === "Upcoming").length}
                  </div>
                </div>
                <div className="kpi-card">
                  <div className="kpi-label">Completed</div>
                  <div className="kpi-value">
                    {eventData.filter((e) => e.status === "Completed").length}
                  </div>
                </div>
                <div className="kpi-card">
